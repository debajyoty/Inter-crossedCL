...
* After that we have to fix some hyperparameters vide. window size; number of bands; training ratio and testing ratio.
* Afterwards we trained our HybridCNNLSTM model.
